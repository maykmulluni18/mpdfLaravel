        ...
        <div class="table_head">
            <table class="table_contend">
                <thead class="table_thead">
                    <tr>
                        <th colspan="12">RESUMEN DE MATRICULADOS POR SEMESTRE</th>
                    </tr>
                    <tr class="tr">
                        ...
                        @foreach($listData[0]['cycles'] as $group)
                        <th scope="col" class="groups th">{{ $group['cycle'] }}</th>
                        @endforeach
                ...
                <tbody>
                    ...
                    @foreach($listData as $courseIndex => $course)

                    <tr>
                        <td class="index td">{{ $courseIndex +1}}</td>
                        <td class="code td">{{ $course['unitCode'] }}</td>
                        <td class="names td">{{ $course['unitName'] }}</td>
                        <td class="groups td" style="text-align: center;">-</td>
                        <td class="groups td" style="text-align: center;">-</td>
                        @foreach($course['cycles'] as $group)
                        <td class="groups td" style="text-align: center;">{{ $group['total'] }}</td>
                        @endforeach
